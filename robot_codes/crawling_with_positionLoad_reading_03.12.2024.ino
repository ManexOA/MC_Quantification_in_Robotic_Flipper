...
Load data from the motors' sensors. [Last edited: 03/12/2024]*/
...
void handleMotorMovement() {
  if (moveMotor && currentMillis - previousMotorMillis >= motorMoveInterval) {
    ...
    switch (step) {
      ...
      case 4:
        dxl.setGoalPosition(DXL_ID1, 245, UNIT_DEGREE); // Move the flipper DOWN
      ...
      case 5: // Flipper dug into sand. // SWEEP STROKE START
        ...
        dxl.setGoalPosition(DXL_ID1, 245, UNIT_DEGREE); // Move the flipper DOWN
        dxl.setGoalPosition(DXL_ID2, 220, UNIT_DEGREE); // Move the flipper BACKWARDS
        step = 6;
        break;

      case 6: 
        dxl.setGoalPosition(DXL_ID1, 235, UNIT_DEGREE); // Move the flipper DOWN
        dxl.setGoalPosition(DXL_ID2, 250, UNIT_DEGREE); // Move the flipper BACKWARDS
        step = 7;
        break;

      case 7:
        dxl.setGoalPosition(DXL_ID1, 210, UNIT_DEGREE); // Move the flipper DOWN
      ...
      case 9: // SWEEP STROKE END
        ...
        delay(2000); // Wait until flipper completes the whole stroke
        step = 10;
        break;
